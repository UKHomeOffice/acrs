...
The basic environment variables for local development of acrs core routes are:
...
The other services used for ACRS include
...
> **Note**: you will need hof-rds-api running locally to successfully run and use ACRS's core user flows. You can also run both Html-pdf-converter and file-vault locally if you want to test integration beyond the ACRS application. 
