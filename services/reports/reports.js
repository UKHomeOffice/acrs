    ...
    return new Promise((resolve, reject) => {
      return fs.readFile(filePath, (err, csvFile) => {
        ...
        return this.auth().then(auth => {
          ...
          logger.log({
            level: 'info',
            message: `ACRS CSV generated for ${this.type}, UUID is: ${fileUUID}`
          });
          ...
          logger.log({
            level: 'info',
            message: `Email sent to ACRS CSV users successfully for ${this.type}`
          });
          await this.#deleteFile(filePath, reject);
          return resolve();
        }).catch(error => {
          ...
          logger.log({
            level: 'info',
            message: `Error generated for ACRS for ${this.type} CSV: ${error}`
          });
        });
      });
    });
